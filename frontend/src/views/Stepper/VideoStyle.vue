<template>
  <div class="container mx-auto my-4 py-4" style="width: 80%;">
    ...
    <div class="container py-4">
      <div class="row">
        <!-- 영상 종류별 버튼 -->
        <div class="col-lg-3 col-md-6" v-for="item of videoStyle" :key="item.value">
          <button
            type="button"
            class="btn my-2"
...
export default {
  ...
  computed: {
    ...mapState({
      videoStyle: state => state.stepper.videoStyle
    }),
  },
  methods: {
    selectVideoStyle(value) {
      this.$store.commit('stepper/selectVideoStyle', value)
    }
  }
};
</script>
